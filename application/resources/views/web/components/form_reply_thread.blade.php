@section('fixed_bottom')
    ...
    <div class="row d-flex-justify-content-center">
        ...
        <form method="POST" class="form_answer_div ajax_form visually-hidden"     action="{{ route('site.board.reply',['alias'=>$board->getAlias(),'thread_id'=>$thread->getId()]) }}">
            ...
            <div class="card " >
                <div class="card-body">
                    ...
                    <div class="col-12 mb-2 mt-2">
                        <div id="editorjs" class="" style="padding-left:100px;" ></div>
                    </div>
